...
| Device / Platform | Linux                                                           | Windows                                 | macOS    | Android          |
| x86_64 CPU        | ✔️ONNXRuntime[![Build Status][pass-backend-ort]][ci-backend-ort]<br>✔️pplnn[![Build Status][pass-backend-pplnn]][ci-backend-pplnn]<br>✔️ncnn[![Build Status][pass-backend-ncnn]][ci-backend-ncnn]<br>✔️OpenVINO<br>✔️LibTorch[![Build Status][pass-backend-torchscript]][ci-backend-torchscript] | ✔️ONNX Runtime<br>✔️OpenVINO            | -        | -                |
| ARM CPU           | ✔️ncnn                                                           | -                                       | -        | ✔️ncnn            |
| RISC-V            | ✔️ncnn                                                           | -                                       | -        | -                |
| NVIDIA GPU        | ✔️ONNX Runtime<br>✔️TensorRT<br>✔️pplnn<br>✔️LibTorch               | ✔️ONNX Runtime<br>✔️TensorRT<br>✔️pplnn    | -        | -                |
| NVIDIA Jetson     | ✔️TensorRT                                                       | ✔️TensorRT                               | -        | -                |
| Huawei ascend310  | ✔️CANN[![Build Status][pass-backend-ascend]][ci-backend-ascend]  | -                                       | -        | -                |
| Rockchip          | ✔️RKNN[![Build Status][pass-backend-rknn]][ci-backend-rknn]      | -                                       | -        | -                |
| Apple M1          | -                                                               | -                                       | ✔️CoreML[![Build Status][pass-backend-coreml]][ci-backend-coreml]| -   |
| Adreno GPU        | -                                                               | -                                       | -        | ✔️ncnn<br>✔️SNPE |
| Hexagon DSP       | -                                                               | -                                       | -        | ✔️SNPE[![Build Status][pass-backend-snpe]][ci-backend-snpe] |
