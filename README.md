...
| NVIDIA GPU        | [![Build Status][pass-build-rknpu]][ci-build-rknpu]✔️ONNXRuntime<br>[![Build Status][pass-build-rknpu]][ci-build-rknpu]✔️TensorRT<br>[![Build Status][pass-build-rknpu]][ci-build-rknpu]✔️pplnn<br>[![Build Status][pass-build-rknpu]][ci-build-rknpu]✔️LibTorch                                                                                    | [![Build Status][pass-build-rknpu]][ci-build-rknpu]✔️ONNXRuntime<br>[![Build Status][pass-build-rknpu]][ci-build-rknpu]✔️TensorRT<br>[![Build Status][pass-build-rknpu]][ci-build-rknpu]✔️pplnn | -                                                                 | -                                                                                                                        |
