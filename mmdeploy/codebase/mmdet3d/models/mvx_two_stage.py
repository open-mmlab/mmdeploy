...
@FUNCTION_REWRITER.register_rewriter('mmdet3d.models.detectors.mvx_two_stage.MVXTwoStageDetector.extract_img_feat')
def mvxtwostagedetector__extract_img_feat(ctx, self, img: torch.Tensor) -> dict:
...
@FUNCTION_REWRITER.register_rewriter('mmdet3d.models.detectors.mvx_two_stage.MVXTwoStageDetector.extract_pts_feat')
def mvxtwostagedetector__extract_pts_feat(ctx, self, voxel_dict: Dict[str, torch.Tensor],
            points: Optional[List[torch.Tensor]] = None,
            img_feats: Optional[Sequence[torch.Tensor]] = None,
            batch_input_metas: Optional[List[dict]] = None) -> Sequence[torch.Tensor]:
...
def mvxtwostagedetector__extract_feat(ctx, self, batch_inputs_dict: dict) -> tuple:
...
def mvxtwostagedetector__forward(ctx,
                                     self,
