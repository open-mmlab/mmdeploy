...
You can find more examples from [here](../../demo/python).
...
For more SDK C API usages, please read these [samples](../../demo/csrc).

#### C# API

Due to limitations on space, we will not present a specific example. But you can find all of them [here](../../demo/csharp).
