...
namespace MMDeployJava {
  ...
  extern "C" {
    JNIEXPORT jobject JNICALL mmdeployRestorerCreateByPath(JNIEnv* env, jobject thiz, jstring modelPath, jstring deviceName, jint deviceID, jobject handlePointer)
    {
      ...
      jobject result=env->NewObject(clazz, initMethod, env->NewStringUTF("mm_handle_t"), (long)restorer);
      return result;
    }
    JNIEXPORT jboolean JNICALL mmdeployRestorerApply(JNIEnv* env, jobject thiz, jobject handlePointer, jobject matsPointer, jint matCount, jobject resultsPointer)
    {
      int status{};
    ...
    JNIEXPORT void JNICALL mmdeployRestorerReleaseResult(JNIEnv* env, jobject thiz, jobject resultsPointer, jint count)
    {
      jclass results_clazz = env->GetObjectClass(resultsPointer);
      jfieldID id_results_address = env->GetFieldID(results_clazz, "address", "J");
      jlong presults = env->GetLongField(resultsPointer, id_results_address);
    ...
    static JNINativeMethod method[]={
      {"mmdeployRestorerCreateByPath", "(Ljava/lang/String;Ljava/lang/String;ILcom/openmmlab/mmdeployxrestorer/PointerWrapper;)Lcom/openmmlab/mmdeployxrestorer/PointerWrapper;",(bool*)mmdeployRestorerCreateByPath},
      {"mmdeployRestorerApply", "(Lcom/openmmlab/mmdeployxrestorer/PointerWrapper;Lcom/openmmlab/mmdeployxrestorer/PointerWrapper;ILcom/openmmlab/mmdeployxrestorer/PointerWrapper;)Z",(bool*)mmdeployRestorerApply},
      {"mmdeployRestorerReleaseResult", "(Lcom/openmmlab/mmdeployxrestorer/PointerWrapper;I)V", (void*)mmdeployRestorerReleaseResult},
      {"mmdeployRestorerDestroy", "(Lcom/openmmlab/mmdeployxrestorer/PointerWrapper;)V", (void*)mmdeployRestorerDestroy}
    };
