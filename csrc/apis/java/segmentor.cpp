...
namespace MMDeployJava {
  ...
  extern "C" {
    JNIEXPORT jobject JNICALL mmdeploySegmentorCreateByPath(JNIEnv* env, jobject thiz, jstring modelPath, jstring deviceName, jint deviceID, jobject handlePointer)
    {
      ...
      jobject result=env->NewObject(clazz, initMethod, env->NewStringUTF("mm_handle_t"), (long)segmentor);
      return result;
    }
    JNIEXPORT jboolean JNICALL mmdeploySegmentorApply(JNIEnv* env, jobject thiz, jobject handlePointer, jobject matsPointer, jint matCount, jobject resultsPointer)
    {
      int status{};
    ...
    JNIEXPORT void JNICALL mmdeploySegmentorReleaseResult(JNIEnv* env, jobject thiz, jobject resultsPointer, jint count)
    {
      jclass results_clazz = env->GetObjectClass(resultsPointer);
      jfieldID id_results_address = env->GetFieldID(results_clazz, "address", "J");
      jlong presults = env->GetLongField(resultsPointer, id_results_address);
    ...
    static JNINativeMethod method[]={
      {"mmdeploySegmentorCreateByPath", "(Ljava/lang/String;Ljava/lang/String;ILcom/openmmlab/mmdeployxsegmentor/PointerWrapper;)Lcom/openmmlab/mmdeployxsegmentor/PointerWrapper;",(bool*)mmdeploySegmentorCreateByPath},
      {"mmdeploySegmentorApply", "(Lcom/openmmlab/mmdeployxsegmentor/PointerWrapper;Lcom/openmmlab/mmdeployxsegmentor/PointerWrapper;ILcom/openmmlab/mmdeployxsegmentor/PointerWrapper;)Z",(bool*)mmdeploySegmentorApply},
      {"mmdeploySegmentorReleaseResult", "(Lcom/openmmlab/mmdeployxsegmentor/PointerWrapper;I)V", (void*)mmdeploySegmentorReleaseResult},
      {"mmdeploySegmentorDestroy", "(Lcom/openmmlab/mmdeployxsegmentor/PointerWrapper;)V", (void*)mmdeploySegmentorDestroy}
    };
