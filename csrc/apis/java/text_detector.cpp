...
namespace MMDeployJava {
  ...
  extern "C" {
    JNIEXPORT jobject JNICALL mmdeployTextDetectorCreateByPath(JNIEnv* env, jobject thiz, jstring modelPath, jstring deviceName, jint deviceID, jobject handlePointer)
    {
      ...
      status = mmdeploy_text_detector_create_by_path(model_path, device_name, device_id, &text_detector);
      ...
      jobject result=env->NewObject(clazz, initMethod, env->NewStringUTF("mm_handle_t"), (long)text_detector);
      return result;
    }
    JNIEXPORT jboolean JNICALL mmdeployTextDetectorApply(JNIEnv* env, jobject thiz, jobject handlePointer, jobject matsPointer, jint matCount, jobject resultsPointer, jobject resultCountPointer)
    {
      int status{};
      ...
      status = mmdeploy_text_detector_apply(text_detector, (const mm_mat_t *) pmats, mat_count, &bboxes_apply, &count_apply);
      if (status != MM_SUCCESS) {
    ...
    JNIEXPORT void JNICALL mmdeployTextDetectorReleaseResult(JNIEnv* env, jobject thiz, jobject resultsPointer, jobject resultCountPointer, jint count)
    {
      jclass results_clazz = env->GetObjectClass(resultsPointer);
      jfieldID id_results_address = env->GetFieldID(results_clazz, "address", "J");
      jlong presults = env->GetLongField(resultsPointer, id_results_address);
    ...
    JNIEXPORT void JNICALL mmdeployTextDetectorDestroy(JNIEnv* env, jobject thiz, jobject handlePointer) {
      jclass handle_clazz = env->GetObjectClass(handlePointer);
      jfieldID id_handle_address = env->GetFieldID(handle_clazz, "address", "J");
      long phandle = (long)env->GetLongField(handlePointer, id_handle_address);
      mm_handle_t text_detector = (mm_handle_t)phandle;
    ...
    static JNINativeMethod method[]={
      {"mmdeployTextDetectorCreateByPath", "(Ljava/lang/String;Ljava/lang/String;ILcom/openmmlab/mmdeployxtextdetector/PointerWrapper;)Lcom/openmmlab/mmdeployxtextdetector/PointerWrapper;",(bool*)mmdeployTextDetectorCreateByPath},
      {"mmdeployTextDetectorApply", "(Lcom/openmmlab/mmdeployxtextdetector/PointerWrapper;Lcom/openmmlab/mmdeployxtextdetector/PointerWrapper;ILcom/openmmlab/mmdeployxtextdetector/PointerWrapper;Lcom/openmmlab/mmdeployxtextdetector/PointerWrapper;)Z",(bool*)mmdeployTextDetectorApply},
      {"mmdeployTextDetectorReleaseResult", "(Lcom/openmmlab/mmdeploytextxdetector/PointerWrapper;Lcom/openmmlab/mmdeploytextxdetector/PointerWrapper;I)V", (void*)mmdeployTextDetectorReleaseResult},
      {"mmdeployTextDetectorDestroy", "(Lcom/openmmlab/mmdeployxtextdetector/PointerWrapper;)V", (void*)mmdeployTextDetectorDestroy}
    };
