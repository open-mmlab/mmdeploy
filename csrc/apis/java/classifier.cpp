...
extern "C" {
JNIEXPORT jobject JNICALL mmdeployClassifierCreateByPath(JNIEnv* env, jobject thiz,
...
JNIEXPORT jboolean JNICALL mmdeployClassifierApply(JNIEnv* env, jobject thiz, jobject handlePointer,
...
JNIEXPORT void JNICALL mmdeployClassifierReleaseResult(JNIEnv* env, jobject thiz,
                                                       jobject resultsPointer,
...
static JNINativeMethod method[] = {
    {"mmdeployClassifierCreateByPath",
     "(Ljava/lang/String;Ljava/lang/String;ILcom/openmmlab/mmdeployxclassifier/"
     "PointerWrapper;)Lcom/openmmlab/mmdeployxclassifier/PointerWrapper;",
     (bool*)mmdeployClassifierCreateByPath},
    {"mmdeployClassifierApply",
     "(Lcom/openmmlab/mmdeployxclassifier/PointerWrapper;Lcom/openmmlab/mmdeployxclassifier/"
     "PointerWrapper;ILcom/openmmlab/mmdeployxclassifier/PointerWrapper;Lcom/openmmlab/"
     "mmdeployxclassifier/PointerWrapper;)Z",
     (bool*)mmdeployClassifierApply},
    {"mmdeployClassifierReleaseResult",
     "(Lcom/openmmlab/mmdeployxclassifier/PointerWrapper;Lcom/openmmlab/mmdeployxclassifier/"
     "PointerWrapper;I)V",
     (void*)mmdeployClassifierReleaseResult},
    {"mmdeployClassifierDestroy", "(Lcom/openmmlab/mmdeployxclassifier/PointerWrapper;)V",
     (void*)mmdeployClassifierDestroy}};
