...
extern "C" {
JNIEXPORT jobject JNICALL mmdeployTextRecognizerCreateByPath(JNIEnv* env, jobject thiz,
  ...
  status =
      mmdeploy_text_recognizer_create_by_path(model_path, device_name, device_id, &text_recognizer);
  ...
  jobject result =
      env->NewObject(clazz, initMethod, env->NewStringUTF("mm_handle_t"), (long)text_recognizer);
  return result;
}
JNIEXPORT jboolean JNICALL mmdeployTextRecognizerApply(JNIEnv* env, jobject thiz,
  ...
  status = mmdeploy_text_recognizer_apply(text_recognizer, (const mm_mat_t*)pmats, mat_count,
                                          &result_apply);
  if (status != MM_SUCCESS) {
...
JNIEXPORT void JNICALL mmdeployTextRecognizerReleaseResult(JNIEnv* env, jobject thiz,
...
JNIEXPORT void JNICALL mmdeployTextRecognizerDestroy(JNIEnv* env, jobject thiz,
...
static JNINativeMethod method[] = {
    {"mmdeployTextRecognizerCreateByPath",
     "(Ljava/lang/String;Ljava/lang/String;ILcom/openmmlab/mmdeployxtextrecognizer/"
     "PointerWrapper;)Lcom/openmmlab/mmdeployxtextrecognizer/PointerWrapper;",
     (bool*)mmdeployTextRecognizerCreateByPath},
    {"mmdeployTextRecognizerApply",
     "(Lcom/openmmlab/mmdeployxtextrecognizer/PointerWrapper;Lcom/openmmlab/"
     "mmdeployxtextrecognizer/PointerWrapper;ILcom/openmmlab/mmdeployxtextrecognizer/"
     "PointerWrapper;)Z",
     (bool*)mmdeployTextRecognizerApply},
    {"mmdeployTextRecognizerReleaseResult",
     "(Lcom/openmmlab/mmdeployxtextrecognizer/PointerWrapper;I)V",
     (void*)mmdeployTextRecognizerReleaseResult},
    {"mmdeployTextRecognizerDestroy", "(Lcom/openmmlab/mmdeployxtextrecognizer/PointerWrapper;)V",
     (void*)mmdeployTextRecognizerDestroy}};
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved) {
  ...
  jclass jClassName =
      env->FindClass("com/openmmlab/mmdeployxtextrecognizer/MMDeployTextRecognizer");
