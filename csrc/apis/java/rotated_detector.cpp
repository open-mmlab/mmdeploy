...
namespace MMDeployJava {
  ...
  extern "C" {
    JNIEXPORT jobject JNICALL mmdeployRotatedDetectorCreateByPath(JNIEnv* env, jobject thiz, jstring modelPath, jstring deviceName, jint deviceID, jobject handlePointer)
    {
      ...
      status = mmdeploy_rotated_detector_create_by_path(model_path, device_name, device_id, &rotated_detector);
      ...
      jobject result=env->NewObject(clazz, initMethod, env->NewStringUTF("mm_handle_t"), (long)rotated_detector);
      return result;
    }
    JNIEXPORT jboolean JNICALL mmdeployRotatedDetectorApply(JNIEnv* env, jobject thiz, jobject handlePointer, jobject matsPointer, jint matCount, jobject resultsPointer, jobject resultCountPointer)
    {
      int status{};
      ...
      status = mmdeploy_rotated_detector_apply(rotated_detector, (const mm_mat_t *) pmats, mat_count, &result_apply, &count_apply);
      if (status != MM_SUCCESS) {
    ...
    JNIEXPORT void JNICALL mmdeployRotatedDetectorReleaseResult(JNIEnv* env, jobject thiz, jobject resultsPointer, jobject resultCountPointer)
    {
      jclass results_clazz = env->GetObjectClass(resultsPointer);
      jfieldID id_results_address = env->GetFieldID(results_clazz, "address", "J");
      jlong presults = env->GetLongField(resultsPointer, id_results_address);
    ...
    JNIEXPORT void JNICALL mmdeployRotatedDetectorDestroy(JNIEnv* env, jobject thiz, jobject handlePointer) {
      jclass handle_clazz = env->GetObjectClass(handlePointer);
      jfieldID id_handle_address = env->GetFieldID(handle_clazz, "address", "J");
      long phandle = (long)env->GetLongField(handlePointer, id_handle_address);
      mm_handle_t rotated_detector = (mm_handle_t)phandle;
    ...
    static JNINativeMethod method[]={
      {"mmdeployRotatedDetectorCreateByPath", "(Ljava/lang/String;Ljava/lang/String;ILcom/openmmlab/mmdeployxrotateddetector/PointerWrapper;)Lcom/openmmlab/mmdeployxrotateddetector/PointerWrapper;",(bool*)mmdeployRotatedDetectorCreateByPath},
      {"mmdeployRotatedDetectorApply", "(Lcom/openmmlab/mmdeployxrotateddetector/PointerWrapper;Lcom/openmmlab/mmdeployxrotateddetector/PointerWrapper;ILcom/openmmlab/mmdeployxrotateddetector/PointerWrapper;Lcom/openmmlab/mmdeployxrotateddetector/PointerWrapper;)Z",(bool*)mmdeployRotatedDetectorApply},
      {"mmdeployRotatedDetectorReleaseResult", "(Lcom/openmmlab/mmdeployxrotateddetector/PointerWrapper;Lcom/openmmlab/mmdeployxrotateddetector/PointerWrapper;)V", (void*)mmdeployRotatedDetectorReleaseResult},
      {"mmdeployRotatedDetectorDestroy", "(Lcom/openmmlab/mmdeployxrotateddetector/PointerWrapper;)V", (void*)mmdeployRotatedDetectorDestroy}
    };
    JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved){
      ...
      jclass jClassName=env->FindClass("com/openmmlab/mmdeployxrotateddetector/MMDeployRotatedDetector");
