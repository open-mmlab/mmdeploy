 ...
 */
JNIEXPORT jlong JNICALL Java_mmdeploy_Classifier_create
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_mmdeploy_Classifier_destroy
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_mmdeploy_Classifier_apply
