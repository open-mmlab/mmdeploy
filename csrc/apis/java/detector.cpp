...
extern "C" {
JNIEXPORT jobject JNICALL mmdeployDetectorCreateByPath(JNIEnv* env, jobject thiz, jstring modelPath,
...
JNIEXPORT jboolean JNICALL mmdeployDetectorApply(JNIEnv* env, jobject thiz, jobject handlePointer,
...
JNIEXPORT void JNICALL mmdeployDetectorReleaseResult(JNIEnv* env, jobject thiz,
                                                     jobject resultsPointer,
...
static JNINativeMethod method[] = {
    {"mmdeployDetectorCreateByPath",
     "(Ljava/lang/String;Ljava/lang/String;ILcom/openmmlab/mmdeployxdetector/PointerWrapper;)Lcom/"
     "openmmlab/mmdeployxdetector/PointerWrapper;",
     (bool*)mmdeployDetectorCreateByPath},
    {"mmdeployDetectorApply",
     "(Lcom/openmmlab/mmdeployxdetector/PointerWrapper;Lcom/openmmlab/mmdeployxdetector/"
     "PointerWrapper;ILcom/openmmlab/mmdeployxdetector/PointerWrapper;Lcom/openmmlab/"
     "mmdeployxdetector/PointerWrapper;)Z",
     (bool*)mmdeployDetectorApply},
    {"mmdeployDetectorReleaseResult",
     "(Lcom/openmmlab/mmdeployxdetector/PointerWrapper;Lcom/openmmlab/mmdeployxdetector/"
     "PointerWrapper;I)V",
     (void*)mmdeployDetectorReleaseResult},
    {"mmdeployDetectorDestroy", "(Lcom/openmmlab/mmdeployxdetector/PointerWrapper;)V",
     (void*)mmdeployDetectorDestroy}};
