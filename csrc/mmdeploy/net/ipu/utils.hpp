...
// inline void print(const std::string &msg, _IO_FILE *out) { print(msg.c_str(), out); }
...
// inline boost::program_options::variables_map parsePopefProgramOptions(const char *example_desc,
//                                                                       int argc, char *argv[]) {
//   using namespace boost::program_options;
//   variables_map vm;
...
//     options_description desc{example_desc};
//     desc.add_options()("help,h", "Help screen")(
//         "popef,p", value<std::vector<std::string>>()->required()->multitoken()->composing(),
//         "A collection of PopEF files containing the model.");
...
// inline model_runtime::AnchorCallbackPredicate filterMainOrEmpty(
//     std::shared_ptr<popef::Model> model) {
//   static constexpr auto acceptPolicy = model_runtime::AnchorCallbackPolicy::BIND_USER_CB;
//   static constexpr auto rejectPolicy = model_runtime::AnchorCallbackPolicy::BIND_EMPTY_CB;

//   return model_runtime::predicate_factory::operators::orBind(
//       acceptPolicy, rejectPolicy,
//       model_runtime::predicate_factory::predProgramFlowMain(model->metadata.programFlow(),
//                                                             acceptPolicy, rejectPolicy),
//       model_runtime::predicate_factory::predProgramNotAssigned(acceptPolicy, rejectPolicy));
// }
...
//     examples::print(fmt::format("Allocating tensor {}, {} bytes.", name, size_in_bytes));
...
//   for (const InputValueType &name_with_memory : input_memory) {
//     auto &&[name, memory] = name_with_memory;
//     examples::print(fmt::format("Input tensor {}, {} bytes", name, memory.data_size_bytes));
//   }
// }
