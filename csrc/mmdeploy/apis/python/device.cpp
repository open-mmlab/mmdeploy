...
static PythonBindingRegisterer register_device{
    "Device", [](py::module& m) {
...
static PythonBindingRegisterer register_context{
    "Context", [](py::module& m) {
...
static PythonBindingRegisterer register_scheduler{
    "Scheduler", [](py::module& m) {
