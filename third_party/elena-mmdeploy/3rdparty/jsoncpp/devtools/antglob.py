...
def ant_pattern_to_re(ant_pattern):
    """Generates a regular expression from the ant pattern. Matching
    convention:
    ...
    def glob_impl(root_dir_path):
        ...
        while child_dirs:
            ...
            for entry in listdir(dir_path):
                ...
                if is_dir and not is_pruned_dir(
                        entry):  # explore child directory ?
    ...
    class AntPatternToRETest(unittest.TestCase):
        ...
        def test_matching(self):
            test_cases = [
                ...
                ('*.py', ['source.py', 'source.ext.py', '.py'],
                 ['path/source.py', '/.py', 'dir.py/z', 'z.pyc', 'z.c']),
                ('**/path', [
                    'path', '/path', '/a/path', 'c:/a/path', '/a/b/path',
                    '//a/path', '/a/path/b/path'
                ], [
                    'path/', 'a/path/b', 'dir.py/z', 'somepath', 'pathsuffix',
                    'a/somepath'
                ]),
                ('path/**', ['path/a', 'path/path/a', 'path//'],
                ...
                ('src/**/*.py', ['src/a.py',
                                 'src/dir/a.py'], ['a/src/a.py', '/src/a.py']),
            ]
            for ant_pattern, accepted_matches, rejected_matches in list(
                    test_cases):
