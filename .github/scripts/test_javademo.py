...
PARAMS = [{'task': 'ImageClassification', 'configs': [[
        'resnet',
    ...
    {'task': 'ImageSegmentation', 'configs': [[
        'fcn',
...
def main():
    ...
    for params in PARAMS:
        ...
        java_demo_cmd = ['java', '-cp', 'csrc/mmdeploy/apis/java/mmdeploy',
